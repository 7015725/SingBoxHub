/*
 * SingBoxHub Stage 33 Retry 6: rollback modal focus parity.
 * Restores the Stage 33 Retry 4 window-layout baseline.
 * ShortX / Rhino ES5.
 */
(function () {
    "use strict";
    ...
    source = replaceRequired(
        ...
        "var ENTRY_VERSION = 46;",
        "entry version"
    );

    source = replaceRequired(
        source,
        "var MODULE_SET_VERSION = manifest.moduleSetVersion;",
        "var MODULE_SET_VERSION = manifest.moduleSetVersion;",
        "module set marker"
    );
