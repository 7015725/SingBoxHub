/*
 * SingBoxHub Stage 31 Retry 1: isolated UI render recovery entry.
 *
 * Loads the verified base UI bootstrap from a pinned commit, then upgrades
 * only the entry version and module list for the cleaned authenticated
 * read-only Runtime adapter candidate with bounded UI render recovery.
 *
