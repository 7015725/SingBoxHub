/*
 * SingBoxHub Stage 37 Retry 1: module hash consistency repair.
...
(function () {
    ...
    source = replaceRequired(
        ...
        "var RAW_BASE = \"https://raw.githubusercontent.com/7015725/SingBoxHub/ebfb9cff7740fe230041be0adfa4fe8df05d8568/\";",
    ...
    result.stage = "subscription_stage37_retry1_hash_consistency";
    result.strictModuleActivation = true;
    result.subscriptionStage = 37;
    result.subscriptionCrudExpected = true;
    result.hashConsistencyRepair = true;
    result.repairedModule = "sbh_44_subscription_crud_ui.js";
    result.repairedModuleSha256 = "f94c8cdc14695bedda94394ef63e4ba05bf92618eebb7e598c3442826f2ef8bc";
    result.subscriptionDownloadEnabled = false;
    ...
    result.pinnedModuleCommit =
        "ebfb9cff7740fe230041be0adfa4fe8df05d8568";
    result.expectedModuleSetVersion = "20260803.11";
    result.expectedModuleCount = 23;
    result.expectedLastModule = "sbh_44_subscription_crud_ui.js";
    result.moduleSetActivated =
        result.ok === true &&
        String(result.moduleSetVersion || "") === "20260803.11" &&
        result.sync &&
